...
<h1 align="center">SLiMski Themes</h1>
...
clone this repository & then copy all themes in `/usr/share/slimski/themes`.
To apply new theme, enter the theme name on the current_theme line in ***/etc/slimski.conf*** -

```sh
#current_theme       default
current_theme       milk
```
**Help** : For extra help, follow this [article](https://wiki.archlinux.org/index.php/SLiM). this will not be perfectly ac
...
- All of this code is a modification of [adi1090x's SLiM themes](https://github.com/adi1090x/slim_themes).
